...
<table style="width:100%; text-align:center;">
  <tr>
    <td>
      <div align="center" id="slider5" style="width: 300px;"></div>
    </td>
    <td>
      <div align="center" id="slider6" style="width: 300px;"></div>
    </td>
    <td>
      <div align="center" id="slider7" style="width: 300px;"></div>
    </td>
    </tr>
</table>
...
<table style="width:100%; text-align:center;">
  <tr>
    <td>
      <div align="center" id="slider1" style="display:inline-block; width: 200px;"></div>
    </td>
    <td>
      <div align="center" id="slider2" style="display:inline-block; width: 200px;"></div>
    </td>
    <td>
      <div align="center" id="slider3" style="display:inline-block; width: 200px;"></div>
    </td>
    <td>
      <div align="center" id="slider4" style="display:inline-block; width: 200px;"></div>
    </td>
  </tr>
</table>
...
<script>
  new juxtapose.JXSlider('#slider5',
    [
      {src: '../assets/img/dmsr/lr1.jpg', label: 'Before'},
      {src: '../assets/img/dmsr/sr1.png',label: 'After'}
    ],
    {
      animate: true,
      showLabels: true,
  ...
  new juxtapose.JXSlider('#slider6',
    [
      {src: '../assets/img/dmsr/lr2.jpg', label: 'Before'},
      {src: '../assets/img/dmsr/sr2.png',label: 'After'}
    ],
    {
      animate: true,
      showLabels: true,
   ...
   new juxtapose.JXSlider('#slider7',
    [
      {src: '../assets/img/dmsr/lr3.jpg', label: 'Before'},
      {src: '../assets/img/dmsr/sr3.png',label: 'After'}
    ],
    {
      animate: true,
      showLabels: true,
