...
<script>
  new juxtapose.JXSlider('#juxtapose',
    [
      {
        src: '../assets/img/dmsr/lr6.jpg', '../assets/img/dmsr/lr6.jpg',
        label: 'Before'
      },
      {
        src: '../assets/img/dmsr/sr6.png', '../assets/img/dmsr/sr6.png',
        label: 'After'
      }
    ],
    {
...
<script>
  new juxtapose.JXSlider('#juxtapose',
    [
      {
        src: '../assets/img/dmsr/lr6.jpg',
        label: 'Before'
      },
      {
        src: '../assets/img/dmsr/sr6.png',
        label: 'After'
      }
    ],
    {
